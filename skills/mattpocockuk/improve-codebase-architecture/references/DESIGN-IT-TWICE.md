...
Spawn three sub-agents in parallel, within the available concurrency limit. If delegation is unavailable, develop the contrasting designs sequentially using the same constraints. Each must produce a **radically different** interface for the deepened module.
