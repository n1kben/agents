---
name: tiger-style
description: Apply TigerBeetle's canonical TigerStyle engineering principles when explicitly invoked for Zig implementation, design, or review.
disable-model-invocation: true
license: Apache-2.0
---

<!-- Modified from TigerBeetle docs/TIGER_STYLE.md only by adding the skill metadata above. -->
